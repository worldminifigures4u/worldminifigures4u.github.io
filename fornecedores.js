...
function garantirFornecedoresProdutoModal() {
    ...
    if (!__fornecedoresProdutoPromessa) {
        ...
        __fornecedoresProdutoPromessa = carregarScriptAdmin("mapas-produto-modal.js?v=20260919-remover-imagens")
            .then(function () {
...
function garantirFornecedoresEdicaoPedido() {
    ...
    if (!__fornecedoresEdicaoPromessa) {
        __fornecedoresEdicaoPromessa = carregarScriptAdmin("fornecedores-edicao-pedido.js?v=20260919-fechar-vermelho");
    }
