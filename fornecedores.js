...
function garantirFornecedoresProdutoModal() {
    ...
    if (!__fornecedoresProdutoPromessa) {
        ...
        __fornecedoresProdutoPromessa = carregarScriptAdmin("mapas-produto-modal.js?v=20260926-marcacoes-resumo")
            .then(function () {
...
function garantirFornecedoresEdicaoPedido() {
    ...
    if (!__fornecedoresEdicaoPromessa) {
        __fornecedoresEdicaoPromessa = carregarScriptAdmin("fornecedores-edicao-pedido.js?v=20260925-status-cabecalho");
    }
