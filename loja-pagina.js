...
(function () {
    ...
    function garantirLojaProdutos() {
        ...
        if (!promessaLojaProdutos) {
            promessaLojaProdutos = garantirCartMiniLoja()
                .then(() => carregarScript('loja-produtos.js?v=20260925-busca-flexivel-v3'));
        }
    ...
    function agendarPrefetchModulosLoja() {
        const iniciar = function () {
            ['loja-produtos.js?v=20260925-busca-flexivel-v3', 'cart-mini.js?v=20260711-leve'].forEach(function (href) {
