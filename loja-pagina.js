...
(function () {
    ...
    function garantirLojaProdutos() {
        ...
        if (!promessaLojaProdutos) {
            promessaLojaProdutos = garantirCartMiniLoja()
                .then(() => carregarScript('loja-produtos.js?v=20260926-busca-compacta'));
        }
    ...
    function agendarPrefetchModulosLoja() {
        const iniciar = function () {
            ['loja-produtos.js?v=20260926-busca-compacta', 'cart-mini.js?v=20260711-leve'].forEach(function (href) {
