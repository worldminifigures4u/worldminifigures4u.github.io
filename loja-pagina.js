...
(function () {
    ...
    function garantirLojaProdutos() {
        ...
        if (!promessaLojaProdutos) {
            promessaLojaProdutos = garantirCartMiniLoja()
                .then(() => carregarScript('loja-produtos.js?v=20260721-sem-contador'));
        }
    ...
    function agendarPrefetchModulosLoja() {
        const iniciar = function () {
            ['loja-produtos.js?v=20260721-sem-contador', 'cart-mini.js?v=20260711-leve'].forEach(function (href) {
