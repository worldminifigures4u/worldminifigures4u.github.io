...
from (values
  ...
  ('portugal', 999999, 'inpost_registado', 'InPost Registado (com seguro de 25€)', 7.24, 4),
  -- Espanha
  ('espanha', 100, 'ctt_registado', 'CTT Registado', 7.13, 0),
  ('espanha', 100, 'inpost_registado', 'InPost Registado', 6.30, 1),
  ('espanha', 250, 'ctt_registado', 'CTT Registado', 9.29, 0),
  ('espanha', 250, 'inpost_registado', 'InPost Registado', 6.30, 1),
  ('espanha', 500, 'ctt_registado', 'CTT Registado', 12.05, 0),
  ('espanha', 500, 'inpost_registado', 'InPost Registado', 6.30, 1),
  ('espanha', 1000, 'ctt_registado', 'CTT Registado', 16.24, 0),
  ('espanha', 1000, 'inpost_registado', 'InPost Registado', 6.30, 1),
  ('espanha', 999999, 'ctt_registado', 'CTT Registado', 26.08, 0),
  ('espanha', 999999, 'inpost_registado', 'InPost Registado', 7.15, 1),
  -- Europa
