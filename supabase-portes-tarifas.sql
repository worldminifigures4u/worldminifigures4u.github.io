...
create table if not exists public.portes_tarifas (
  ...
  metodo_id text not null check (metodo_id in (
    'entrega_tomar', 'ctt_normal', 'ctt_azul', 'ctt_azul_internacional', 'ctt_registado', 'inpost_registado'
  )),
...
from (values
  ...
  ('espanha', 100, 'ctt_azul_internacional', 'CTT Azul Internacional', 7.13, 1),
  ('espanha', 100, 'ctt_registado', 'CTT Registado', 7.13, 2),
  ('espanha', 100, 'inpost_registado', 'InPost Registado', 5.12, 3),
  ('espanha', 250, 'ctt_normal', 'CTT Normal', 5.23, 0),
  ('espanha', 250, 'ctt_azul_internacional', 'CTT Azul Internacional', 9.29, 1),
  ('espanha', 250, 'ctt_registado', 'CTT Registado', 9.29, 2),
  ('espanha', 250, 'inpost_registado', 'InPost Registado', 5.12, 3),
  ('espanha', 500, 'ctt_normal', 'CTT Normal', 8.67, 0),
  ('espanha', 500, 'ctt_azul_internacional', 'CTT Azul Internacional', 12.05, 1),
  ('espanha', 500, 'ctt_registado', 'CTT Registado', 12.05, 2),
  ('espanha', 500, 'inpost_registado', 'InPost Registado', 5.12, 3),
  ('espanha', 1000, 'ctt_normal', 'CTT Normal', 13.35, 0),
  ('espanha', 1000, 'ctt_azul_internacional', 'CTT Azul Internacional', 16.24, 1),
  ('espanha', 1000, 'ctt_registado', 'CTT Registado', 16.24, 2),
  ('espanha', 1000, 'inpost_registado', 'InPost Registado', 5.12, 3),
  ('espanha', 999999, 'ctt_normal', 'CTT Normal', 22.72, 0),
  ('espanha', 999999, 'ctt_azul_internacional', 'CTT Azul Internacional', 26.08, 1),
  ('espanha', 999999, 'ctt_registado', 'CTT Registado', 26.08, 2),
  ('espanha', 999999, 'inpost_registado', 'InPost Registado', 5.81, 3),
  -- Europa
  ('europa', 100, 'ctt_normal', 'CTT Normal', 3.26, 0),
  ('europa', 100, 'ctt_azul_internacional', 'CTT Azul Internacional', 7.13, 1),
  ('europa', 100, 'ctt_registado', 'CTT Registado', 7.13, 2),
  ('europa', 250, 'ctt_normal', 'CTT Normal', 5.23, 0),
  ('europa', 250, 'ctt_azul_internacional', 'CTT Azul Internacional', 9.29, 1),
  ('europa', 250, 'ctt_registado', 'CTT Registado', 9.29, 2),
  ('europa', 500, 'ctt_normal', 'CTT Normal', 8.67, 0),
  ('europa', 500, 'ctt_azul_internacional', 'CTT Azul Internacional', 12.05, 1),
  ('europa', 500, 'ctt_registado', 'CTT Registado', 12.05, 2),
  ('europa', 1000, 'ctt_normal', 'CTT Normal', 13.35, 0),
  ('europa', 1000, 'ctt_azul_internacional', 'CTT Azul Internacional', 16.24, 1),
  ('europa', 1000, 'ctt_registado', 'CTT Registado', 16.24, 2),
  ('europa', 999999, 'ctt_normal', 'CTT Normal', 22.72, 0),
  ('europa', 999999, 'ctt_azul_internacional', 'CTT Azul Internacional', 26.08, 1),
  ('europa', 999999, 'ctt_registado', 'CTT Registado', 26.08, 2)
